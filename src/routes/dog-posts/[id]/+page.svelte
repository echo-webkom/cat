    ...
    <div class="border border-zinc-800 bg-zinc-900">
      <div class="p-6 sm:p-8">
        {#if post.tags.includes('important')}
          <div
            class="mb-4 flex items-center gap-1.5 self-start border border-red-500/30 bg-red-500/10 px-3 py-1.5 text-sm font-semibold text-red-400 w-fit"
          >
