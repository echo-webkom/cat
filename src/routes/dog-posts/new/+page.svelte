...
<div class="mx-auto max-w-3xl px-4 sm:px-6">
	<a href="/dog-posts" class="mb-6 inline-flex items-center gap-2 text-sm text-zinc-400 transition-colors hover:text-white">
		← dog-posts
	</a>
	...
	<form onsubmit={submit} class="flex flex-col gap-5">
		<div class="flex flex-col gap-1.5">
			<label for="dp-title" class="text-xs text-zinc-400">title <span class="text-zinc-600">*</span></label>
			<input
				id="dp-title"
				type="text"
		...
		<div class="flex flex-col gap-1.5">
			<label for="dp-tagline" class="text-xs text-zinc-400">tagline <span class="text-zinc-600">*</span></label>
			<input
				id="dp-tagline"
				type="text"
