...
<div class="mx-auto max-w-3xl px-4 sm:px-6">
	<a href="/mouse-clicks" class="mb-6 inline-flex items-center gap-2 text-sm text-zinc-400 transition-colors hover:text-white">
		← mouse-clicks
	</a>
	...
	<form onsubmit={submit} class="flex flex-col gap-5">
		<div class="flex flex-col gap-1.5">
			<label for="mc-title" class="text-xs text-zinc-400">title <span class="text-zinc-600">*</span></label>
			<input
				id="mc-title"
				type="text"
		...
		<div class="flex flex-col gap-1.5">
			<label for="mc-url" class="text-xs text-zinc-400">url <span class="text-zinc-600">*</span></label>
			<input
				id="mc-url"
				type="url"
				placeholder="https://..."
