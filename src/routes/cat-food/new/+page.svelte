...
<div class="mx-auto max-w-3xl px-4 sm:px-6">
	<a href="/cat-food" class="mb-6 inline-flex items-center gap-2 text-sm text-zinc-400 transition-colors hover:text-white">
		← cat-food
	</a>
	...
	<form onsubmit={submit} class="flex flex-col gap-5">
		<div class="flex flex-col gap-1.5">
			<label for="cf-title" class="text-xs text-zinc-400">title <span class="text-zinc-600">*</span></label>
			<input
				id="cf-title"
				type="text"
		...
		<div class="flex flex-col gap-1.5">
			<label for="cf-tagline" class="text-xs text-zinc-400">tagline <span class="text-zinc-600">*</span></label>
			<input
				id="cf-tagline"
				type="text"
		...
		<div class="flex flex-col gap-1.5">
			<label for="cf-image" class="text-xs text-zinc-400">header image url <span class="text-zinc-600">optional</span></label>
			<input
				id="cf-image"
				type="url"
