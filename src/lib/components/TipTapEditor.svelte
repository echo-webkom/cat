...
<div class="border border-zinc-800 bg-zinc-900 transition-colors focus-within:border-[#00ff88]/40">
	...
	<div
		bind:this={element}
		class="tiptap-content px-4 py-3"
