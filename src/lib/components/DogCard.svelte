...
<a
	...
	class="group flex flex-col gap-3 rounded-xl border border-zinc-800 bg-zinc-900 p-5 transition-all hover:border-zinc-700 hover:bg-zinc-800/50"
>
	{#if post.tags.includes('important')}
		<div class="flex items-center gap-1.5 self-start rounded-full bg-red-500/15 px-2.5 py-1 text-xs font-semibold text-red-400">
